        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    Vector2 charMidBasline = (sourceVertices[vertexIndex + 0] +
                                              sourceVertices[vertexIndex + 2]) / 2;
                    ...
                    // --- FIXED: uvs0 is now Vector4[] in new TMP ---
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    // Convert Vector4[] (uvs0) to Vector2[] for mesh.uv
                    Vector4[] uv4 = textInfo.meshInfo[i].uvs0;
                    Vector2[] uv2 = new Vector2[uv4.Length];

                    for (int j = 0; j < uv4.Length; j++)
                        uv2[j] = new Vector2(uv4[j].x, uv4[j].y);
